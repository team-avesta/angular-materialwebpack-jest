...
export default function(app) {
	const events = {
		message: {
			...
			_SHOW_SKELETON_LOADING_SPINNER_: '_SHOW_SKELETON_LOADING_SPINNER_',
			_HIDE_SKELETON_LOADING_SPINNER_: '_HIDE_SKELETON_LOADING_SPINNER_',
			...
			_SHOW_OFFLINE_MESSAGE_: '_SHOW_OFFLINE_MESSAGE_',
			_SHOW_ONLINE_MESSAGE_: '_SHOW_ONLINE_MESSAGE_'
		}
	}
	app.constant('eventsConstantService', events);
}